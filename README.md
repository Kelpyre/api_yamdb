...
В проекте реализована собственная команда csvtosql для автоматического заполнения моделей в БД из .csv файлов. Синтаксис команды - python manage.py csvtosql <путь_до_csv> <название_модели>.
